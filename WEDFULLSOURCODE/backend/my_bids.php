...
<head>
    ...
    <style>
        ...
        .product-thumb { width: 70px; height: 70px; object-fit: cover; border: 1px solid #444; border-radius: 12px; }
        .product-info { display: flex; align-items: center; gap: 14px; }
        .product-info .product-name { color: #ffffff; font-weight: 700; line-height: 1.2; }
        .product-info .product-meta { color: #999; font-size: 0.82rem; }
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>
                                        <div class='product-info'>
                                            <img src='" . normalizeImageUrl($row['image']) . "' class='product-thumb'>
                                            <div>
                                                <div class='product-name'>{$row['name']}</div>
                                                <div class='product-meta'>Mã sản phẩm: #{$row['product_id']}</div>
                                            </div>
                                        </div>
                                      </td>";
